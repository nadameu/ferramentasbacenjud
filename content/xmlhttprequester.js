function ferramentasbacenjud_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
ferramentasbacenjud_xmlhttpRequester.prototype.contentStartRequest = function(details) {
    if ('wrappedJSObject' in details) details = details.wrappedJSObject;
    ...
    switch (scheme) {
        ...
        case "ftp":
            this.chromeWindow.setTimeout(
                ferramentasbacenjud_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
            break;
        default:
...
ferramentasbacenjud_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
